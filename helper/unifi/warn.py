...
MESSAGES = {
    ...
    "clients_truncated": "The client list is truncated; see the total.",
    "envelope_truncated": "The reading was too large to send whole and was shortened.",
